...
module type S = sig
  ...
  (** [add_and_path prefixes k s] same as [add_to_sub prefixes k s], but if some of the prefixes along the path [prefixes] does not exist, they are created and added. Only create strong links. *)
